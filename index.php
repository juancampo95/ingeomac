...
<<<<<<< HEAD
	<section class="no-gutters container-fluid callToAction">
				<h2>Ubicación</h2>
	...
	<footer class="container-fluid pie_d_page section-rojo" style="background-color:#b20a0a;">
        <div class="row">
...
=======
	<?php
		include("footer.php");
	 ?>
>>>>>>> ecf7a8cb32f9ee97392ddd92bb7c1968f286f2a4
